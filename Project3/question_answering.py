...
context_file: File to hold the tagged contexts
              ...
              For every sentence of a paragraph, first line is the word tokens, second line is the pos tags, third line is the iob tags
...
"""
  Returns the cosine similarity between the two input vectors
"""
...
def main():
  ...
  tagged_context_file = "tagged_testing_context_sent.txt"
